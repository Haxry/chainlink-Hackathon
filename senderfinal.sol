...
contract PriceFeed {
    ...
    mapping(address => uint256[]) addressToPriceArray;
    ...
    event PriceRequested(string indexed req);
    ...
    function requestLatestPrice() internal {

        string memory _req="price requested";
